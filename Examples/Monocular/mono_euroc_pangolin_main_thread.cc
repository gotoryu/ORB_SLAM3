...
int main(int argc, char **argv)
{
    ...
    {
        cerr << endl
             << "Usage: ./mono_euroc_pangolin path_to_vocabulary path_to_settings path_to_sequence_folder_1 path_to_times_file_1" << endl;
        return 1;
    }
    ...
    std::thread trackingWorker(TrackingThread, &SLAM, num_seq, nImages, vstrImageLeft, vTimestampsCam);
